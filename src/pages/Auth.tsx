        ...
        <div className="bg-surface border border-border rounded-lg p-6">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={submitting}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white text-gray-800 font-medium rounded-lg hover:bg-gray-100 transition-colors disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={submitting}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-black text-white font-medium rounded-lg hover:bg-gray-900 transition-colors disabled:opacity-50"
            >
